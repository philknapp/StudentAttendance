...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegistrationConnectionString %>" SelectCommand="SELECT top 5 Students.FirstName, Students.LastName, Courses.courseName, CourseAttendance.courseDate, count(*) Total 
...
Group by Students.FirstName, Students.LastName, Courses.courseName, CourseAttendance.courseDate
